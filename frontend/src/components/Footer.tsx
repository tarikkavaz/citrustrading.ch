...
const navigation = {
  social: [
    {
      name: "Instagram",
      href: "https://www.instagram.com/citrustradingandconsulting",
      icon: (props: any) => (
    ...
    {
      name: "Linkedin",
      href: "https://www.linkedin.com/company/citrus-trading-and-consulting-ag/",
      icon: (props: any) => (
      ...
      <Container size="fluid" className="pb-16 pt-16 relative z-20 md:px-12 md:py-8 px-2">
        <div className="gap-8 flex items-center justify-between flex-col md:flex-row">
            ...
            <div>
              ...
              <Link href="https://maps.app.goo.gl/HbrtCie19pPMbwGB7" className="flex items-center leading-7 gap-3 mb-2 hover:text-gray-400">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                </svg>
                Steinwiesenstrasse 17 - 8952 Schlieren, Switzerland
              </Link>
              
              <Link href="mailto:info@citrustrading.ch" className="text-sm leading-5 flex items-center gap-3 mb-2 hover:text-gray-400">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
              </svg>
                info@citrustrading.ch
                </Link>
              <Link href="call:0041434373311" className="text-sm leading-5 flex items-center gap-3 mb-2 hover:text-gray-400">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
